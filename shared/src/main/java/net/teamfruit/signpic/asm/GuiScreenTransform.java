...
public class GuiScreenTransform implements INodeCoreTransformer {
	...
	public static class GuiScreenVisitor extends ClassVisitor {
		...
		public GuiScreenVisitor(final @Nonnull String obfClassName, final @Nonnull ClassVisitor cv) {
			...
			this.matcher = new MethodMatcher(ClassName.of(obfClassName), DescHelper.toDescMethod(void.class), ASMDeobfNames.GuiScreenHandleInput);
		}
