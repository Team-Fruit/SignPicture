	...
	protected void initWidget() {
		add(new WPanel(new R(Coord.right(10), Coord.top(5), Coord.left(10), Coord.bottom(5))) {
			protected @Nonnull VMotion o = V.pm(0f).add(Motion.blank(1.5f).setAfter(() -> {
				add(new MScaledLabel(new R(Coord.top(0), Coord.height(9))).setText(I18n.format("signpic.over.hub.usage.takerange", KeyHandler.keyScreenShot.getName())).setAlign(Align.LEFT).setShadow(true));
				add(new MScaledLabel(new R(Coord.top(9), Coord.height(9))).setText(I18n.format("signpic.over.hub.usage.takeall", KeyHandler.keyScreenShotFull.getName())).setAlign(Align.LEFT).setShadow(true));
				add(new MScaledLabel(new R(Coord.top(18), Coord.height(9))).setText(I18n.format("signpic.over.hub.usage.takerangewindow", KeyHandler.keySwingScreenShot.getName())).setAlign(Align.LEFT).setShadow(true));
				add(new MScaledLabel(new R(Coord.top(27), Coord.height(9))).setText(I18n.format("signpic.over.hub.usage.release")).setAlign(Align.LEFT).setShadow(true));
