...
import net.teamfruit.bnnwidget.component.MChatTextField;
...
import net.teamfruit.signpic.asm.ASMDeobfNames;
import net.teamfruit.signpic.attr.AttrWriters;
import net.teamfruit.signpic.attr.AttrWriters.AttrWriter;
...
import net.teamfruit.signpic.gui.GuiMain.SignEditor.MainTextField;
import net.teamfruit.signpic.gui.GuiRotation.RefRotation;
import net.teamfruit.signpic.gui.file.McUiUpload;
...
import net.teamfruit.signpic.reflect.lib.ReflectMethod;
...
public class GuiMain extends WFrame {
	...
	public static boolean setContentId(final @Nonnull String id) {
		final GuiMain editor = WFrame.getCurrentWidgetWithCheck(GuiMain.class);
		if (editor!=null) {
			editor.setURL(id);
			return true;
		} else {
