...
public abstract class CompatItemSignRenderer implements IBakedModel {
	...
	public abstract void renderSignPicture(final @Nonnull ItemSignTransformType type, final @Nonnull CompatBaseVersion version, final @Nullable ItemStack item);
	...
	public CompatBakedModel injectBakedModel(@Nonnull final CompatBakedModel bakedModel) {
		setBaseModel(bakedModel.bakedModel);
		return new CompatBakedModel(this);
	}
