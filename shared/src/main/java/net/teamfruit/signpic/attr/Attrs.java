...
import net.teamfruit.signpic.attr.PropReader.IPropReader;
import net.teamfruit.signpic.attr.prop.AnimationData;
import net.teamfruit.signpic.attr.prop.OffsetData;
import net.teamfruit.signpic.attr.prop.PropSyntax;
import net.teamfruit.signpic.attr.prop.SizeData;
import net.teamfruit.signpic.attr.prop.AnimationData.AnimationBuilder;
import net.teamfruit.signpic.attr.prop.OffsetData.OffsetBuilder;
import net.teamfruit.signpic.attr.prop.OffsetData.OffsetDoublePropBuilder;
import net.teamfruit.signpic.attr.prop.OffsetData.OffsetPropBuilder;
import net.teamfruit.signpic.attr.prop.RotationData.DiffRotation;
import net.teamfruit.signpic.attr.prop.RotationData.KeyRotation;
import net.teamfruit.signpic.attr.prop.RotationData.RotationBuilder;
import net.teamfruit.signpic.attr.prop.SizeData.SizeBuilder;
import net.teamfruit.signpic.attr.prop.TextureData.TextureBlend;
import net.teamfruit.signpic.attr.prop.TextureData.TextureBoolean;
import net.teamfruit.signpic.attr.prop.TextureData.TextureFloat;
import net.teamfruit.signpic.attr.prop.TextureData.TextureBlend.TextureBlendBuilder;
import net.teamfruit.signpic.attr.prop.TextureData.TextureBlend.TextureBlendType;
import net.teamfruit.signpic.attr.prop.TextureData.TextureBoolean.TextureBooleanBuilder;
import net.teamfruit.signpic.attr.prop.TextureData.TextureBoolean.TextureBooleanType;
import net.teamfruit.signpic.attr.prop.TextureData.TextureFloat.TextureFloatBuilder;
import net.teamfruit.signpic.attr.prop.TextureData.TextureFloat.TextureFloatType;
