package net.teamfruit.signpic.attr.prop;
...
import net.teamfruit.signpic.attr.IPropBuilder;
import net.teamfruit.signpic.attr.IPropComposable;
import net.teamfruit.signpic.attr.IPropInterpolatable;
