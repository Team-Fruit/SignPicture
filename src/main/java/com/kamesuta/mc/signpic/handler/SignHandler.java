...
import com.kamesuta.mc.signpic.gui.GuiPacketWait;
			...
			if (event.gui instanceof GuiEditSign) {
				if (f != null) {
					try {
						...
						Client.mc.displayGuiScreen(new GuiPacketWait(new SendPacketTask(CurrentMode.instance.getEntryId(), tileSign)));
