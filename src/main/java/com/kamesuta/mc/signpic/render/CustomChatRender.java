...
public class CustomChatRender {
	...
	public static class PicChatLine extends ChatLine {
		public static final @Nonnull ITextComponent dummytext = new TextComponentString("");
					...
					if (content!=null) {
						...
						return new TextComponentString("")
								.setStyle(new Style()
										...
										.setClickEvent(new ClickEvent(ClickEvent.Action.RUN_COMMAND, "/signpic image open "+url)));
					}
			}
			return null;
		}
	...
	public static class PicChatNode {
			...
			if (!lines.equals(this.linescache)) {
				...
				int chatLineID = -1;
				{
					...
					for (final ChatLine line : lines) {
						...
						final ITextComponent cc = line.getChatComponent();
		...
		public static @Nonnull List<ClickEvent> getLinksFromChat(final @Nonnull ITextComponent chat) {
			final List<ClickEvent> list = Lists.newLinkedList();
			getLinksFromChat0(list, chat);
			return list;
		}

		private static void getLinksFromChat0(final @Nonnull List<ClickEvent> list, final @Nonnull ITextComponent pchat) {
