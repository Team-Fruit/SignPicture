...
public abstract class SubCommand implements IModCommand {
	...
	@Override
	public void execute(final @Nullable ICommandSender sender, final @Nullable String[] args) throws CommandException {
	...
	@Override
	public boolean canCommandSenderUse(final @Nullable ICommandSender sender) {
		if (sender!=null)
	...
	@Override
	public int compareTo(final @Nullable Object obj) {
