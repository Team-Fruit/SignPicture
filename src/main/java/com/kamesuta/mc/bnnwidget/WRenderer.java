...
public class WRenderer {
	...
	public static enum BlendType {
		...
		ZERO(0, GL_ZERO),
		ONE(1, GL_ONE),
		SRC_COLOR(0, GL_SRC_COLOR),
		ONE_MINUS_SRC_COLOR(0, GL_ONE_MINUS_SRC_COLOR),
		DST_COLOR(0, GL_DST_COLOR),
		ONE_MINUS_DST_COLOR(0, GL_ONE_MINUS_DST_COLOR),
		SRC_ALPHA(0, GL_SRC_ALPHA),
		ONE_MINUS_SRC_ALPHA(0, GL_ONE_MINUS_SRC_ALPHA),
		DST_ALPHA(0, GL_DST_ALPHA),
		ONE_MINUS_DST_ALPHA(0, GL_ONE_MINUS_DST_ALPHA),
		SRC_ALPHA_SATURATE(0, GL_SRC_ALPHA_SATURATE),
		CONSTANT_COLOR(0, GL_CONSTANT_COLOR),
		ONE_MINUS_CONSTANT_COLOR(0, GL_ONE_MINUS_CONSTANT_COLOR),
		CONSTANT_ALPHA(0, GL_CONSTANT_ALPHA),
		ONE_MINUS_CONSTANT_ALPHA(0, GL_ONE_MINUS_CONSTANT_ALPHA),
		// @formatter:on
