...
import net.teamfruit.signpic.http.shortening.BitlyShortener;
import net.teamfruit.signpic.http.shortening.GooglShortener;
import net.teamfruit.signpic.http.shortening.IShortener;
import net.teamfruit.signpic.http.shortening.ShorteningRequest;
import net.teamfruit.signpic.http.upload.GyazoUpload;
import net.teamfruit.signpic.http.upload.IUploader;
